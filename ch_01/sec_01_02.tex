...
\begin{questions}
  ...
  \begin{tasks}
    ...
    \begin{solution}
      \begin{tikzpicture} % rectangle
        % Region where x < 2
        \fill[blue!20] (-3,3) -- (-3,-3) -- (2,-3) -- (2,3) -- cycle;
        \draw[blue, dashed] (2,-3) -- (2,3);
        \draw[->] (-3,0) -- (3,0) node[right] {$x$};
        \draw[->] (0,-3) -- (0,3) node[above] {$y$};
    ...
    \begin{solution}
      \begin{tikzpicture} % rectangle
        % Region where x < 2
        \fill[blue!20] (-3,2) -- (-3,-1) -- (3,-1) -- (3,2) -- cycle;
        \draw[blue, dashed] (-3,-1) -- (3,-1);
        \draw[blue] (-3,2) -- (3,2);
        \draw[->] (-3,0) -- (3,0) node[right] {$x$};
        \draw[->] (0,-3) -- (0,3) node[above] {$y$};
        \node[below right] at (0,2) {$y = 2$};
        \node[below right] at (0,-1) {$y = -1$};
      \end{tikzpicture}
    \end{solution}
    \task $0 \leq x \leq 1$ and $0 \leq y \leq 1$;
    \begin{solution}
